...
const requiredPaths = [
  ...
  "src/features/matches/components/match-editor-screen.tsx",
  "src/features/matches/lib/match-editor.ts",
  "tests/unit/README.md",
  "tests/integration/README.md",
  "tests/e2e/README.md",
  "tests/e2e/landing.spec.ts",
  "tests/e2e/harness-dashboard.spec.ts",
  "tests/e2e/match-editor.spec.ts",
  "tests/visual/README.md",
  "tests/visual/landing-screenshots.spec.ts",
  "tests/visual/match-editor-screenshots.spec.ts"
];
